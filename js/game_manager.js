      ...
      if (tile) {
        ...
        //if (!tile.isDud) {
          if (next && self.testFib(tile.value + next.value) && !next.mergedFrom) {
              ...
              merged.unstable = merged.value === 3
                             || merged.value === 8
                             || merged.value === 21
                             || merged.value === 55
                             || merged.value === 144
                             || merged.value === 377
                             || merged.value > 377 ? (merged.value <= 4 ? 6 : (merged.value <=21 ? merged.value + Math.floor(merged.value/5.235) : merged.value + Math.floor(merged.value/2.426))) : 0;
